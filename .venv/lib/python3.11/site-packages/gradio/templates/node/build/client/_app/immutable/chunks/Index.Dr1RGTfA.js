const __vite__fileDeps=["./vega-embed.module.BCJyd-hl.js","./2.CWvEmQ0K.js","./preload-helper.DpQnamwV.js","./stores.BDzrbkGx.js","./client.C8dUb4ef.js","../assets/2.TZFaIV_n.css","./dsv.CKxpOsHB.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { B as Block, i as BlockTitle, S as Static } from "./2.CWvEmQ0K.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await __vitePreload(() => import("./vega-embed.module.BCJyd-hl.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0, import.meta.url)).default;
    }
