...
import { B as Block, S as Static, f as BlockLabel, N as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-aevR7grt.js';
...
const lang_map = {
  python: () => import('./index28-TIgZzf_4.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-B5j867tL.js'),
      import('./frontmatter-DSl0CDwd.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-Cnq9A69U.js').then((m) => m.json()),
  html: () => import('./index30-CfIR80OF.js').then((m) => m.html()),
  css: () => import('./index31-DMUb7ApO.js').then((m) => m.css()),
  javascript: () => import('./index32-BjZBt5uH.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-BjZBt5uH.js').then(
...
//# sourceMappingURL=Index13-8L9e-1uw.js.map
